...
import { Target, Clock, Zap, Star, CheckCircle2, Circle, Play } from "lucide-react"
...
export function Paths({ paths, activePaths, dailyTasks, onCompleteTask }: PathsProps) {
  const [selectedPath, setSelectedPath] = useState<Path | null>(activePaths[0] || null)
                ...
                <CardContent className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      {Object.keys(task.attributeRewards).length > 0 && (
                        <div className="flex flex-wrap gap-1">
